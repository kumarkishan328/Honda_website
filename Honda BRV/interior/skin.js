...
// Pano2VR 5.0.1/15068
// Filename: simplex_v5-HONDA.ggsk
// Generated Sun May 1 14:21:57 2016
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		this._button_stop_auto_rotate__img.setAttribute('src',basePath + 'images/button_stop_auto_rotate.png');
		...
		this._button_stop_auto_rotate__imgo.setAttribute('src',basePath + 'images/button_stop_auto_rotate__o.png');
		...
		this._button_start_auto_rotate__img.setAttribute('src',basePath + 'images/button_start_auto_rotate.png');
		...
		this._button_start_auto_rotate__imgo.setAttribute('src',basePath + 'images/button_start_auto_rotate__o.png');
		...
		this._button_image_normalscreen__img.setAttribute('src',basePath + 'images/button_image_normalscreen.png');
		...
		this._button_image_normalscreen__imgo.setAttribute('src',basePath + 'images/button_image_normalscreen__o.png');
		...
		this._button_image_normalscreen.ggLeft=-77;
		...
		this._button_image_fullscreen__img.setAttribute('src',basePath + 'images/button_image_fullscreen.png');
		...
		this._button_image_fullscreen__imgo.setAttribute('src',basePath + 'images/button_image_fullscreen__o.png');
		...
		this._button_image_fullscreen.ggLeft=-77;
	...
	function SkinHotspotClass(skinObj,hotspot) {
		...
		} else
		{
			...
			this._hsimage_url__img.setAttribute('src',basePath + 'images/hsimage_url.png');
